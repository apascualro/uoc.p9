...
class JuegosController extends Juego{
	...
	/*=====  RETORNA JUEGOS habilitados ======*/
	public function JuegosVisibles(){
		return $this->retornaJuegosVisibles();
	}
...
if(isset($_POST['operacio2']) && $_POST['operacio2']=='fotus'){
	...
	// Upload directory
		...
		$upload_location = $_SERVER["DOCUMENT_ROOT"]."/vistas/assets/img/productos/";
