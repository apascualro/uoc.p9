        ...
        <?php foreach($Llistat as $objecte){ ?>
          ...
          <tr>
            ...
            <td class="text-right">
              ...
              <a class="btn btn-sm btn-success" href="../../controladores/juegosController.php?operacio=modificar&juego=<?php echo $objecte->idJuego; ?>">
              ...
              <a class="btn btn-sm btn-light" href="juegosController.php?operacio=verDetalle&juego=<?php echo $objecte->idJuego ?>">Ver detalle
              </a>
            </td>
          </tr>
          <?php
