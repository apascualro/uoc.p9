...
<?php foreach($Llistat as $objecte){ ?>
    ...
    <div class="input-container slct">
      <select name="tematica" required>
        ...
        foreach ($tematicasNom as $tematica){
          echo "<option value=$tematica->nombre ";
          if($objecte->tematica == $tematica->nombre){
            echo "selected";
          }
          echo " >".$tematica->nombre."</option>";
  ...
  <div class="col-md-12 mb-3">
    <div class="input-container file">
      ...
      <img class="mt-5 mb-2 ml-2" style="width: 200px;" src="../assets/img/productos/<?php echo $imgPortada ?>"/>
      <input type="file" class="prv1 img-test" id="file2" name="fotoportada" ><?php echo $imgPortada ?>
