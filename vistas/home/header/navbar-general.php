...
<nav class="navbar navbar-light bg-terciary pb-0">

  <a href="<?php echo $inicio ?>" class="navbar-brand text-light ml-2"><h2 class="font-weight-bold">Crazy for board Games</h2></a>
  ...
  <form class="form-inline  mt-n2">
    <!-- <input class="form-control mr-sm-2" type="search" placeholder="Search" aria-label="Search">
      ...
      <?php if(isset($_SESSION["idUsuario"])){ ?> 
        <a class="ml-3" href="<?php echo $login ?>"><svg width="1.5em" height="1.5em" viewBox="0 0 16 16" class="bi bi-gear-fill" fill="white"  xmlns="http://www.w3.org/2000/svg">
        ...
        <a class="ml-3" href="<?php echo $logout ?>"><svg width="1.8em" height="1.8em" viewBox="0 0 16 16" class="bi bi-box-arrow-right" fill="white" xmlns="http://www.w3.org/2000/svg">
          <path fill-rule="evenodd" d="M6 3.5a.5.5 0 0 1 .5-.5h8a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5h-8a.5.5 0 0 1-.5-.5v-2a.5.5 0 0 0-1 0v2A1.5 1.5 0 0 0 6.5 14h8a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 14.5 2h-8A1.5 1.5 0 0 0 5 3.5v2a.5.5 0 0 0 1 0v-2z"/>
          <path fill-rule="evenodd" d="M11.854 8.354a.5.5 0 0 0 0-.708l-3-3a.5.5 0 1 0-.708.708L10.293 7.5H1.5a.5.5 0 0 0 0 1h8.793l-2.147 2.146a.5.5 0 0 0 .708.708l3-3z"/>
        </svg>
      </a>
    <?php }else{ ?> 
      <a data-toggle="modal" data-target="#loginModal" ><svg width="1.5em" height="1.5em" viewBox="0 0 16 16" class="bi bi-person-fill ml-3" fill="white" xmlns="http://www.w3.org/2000/svg">
