	...
	<div class="collapse navbar-collapse" id="navbarTogglerDemo03">
		<ul class="navbar-nav mt-2 mt-lg-0 m-auto" >
			<li class="nav-item pr-5">
				<a class="nav-link font-weight-bold" data-toggle="collapse" data-target="#multiCollapse1" role="button" aria-expanded="false" >Categoria</a>
			</li>
			<li class="nav-item pr-5">
				<a class="nav-link font-weight-bold" data-toggle="collapse" data-target="#multiCollapse2" aria-expanded="false" role="button">Tipo</a>
			</li>
			<li class="nav-item pr-5">
				<a class="nav-link font-weight-bold" data-toggle="collapse" data-target="#multiCollapse3" aria-expanded="false" role="button">Temática</a>
			</li>
			<li class="nav-item pr-5">
				<a class="nav-link font-weight-bold" href="../../vistas/juego/juego-gallery.php?filtro=ninguno" role="button">Todos</a>
			</li>
				...
				<div class="col">
					...
					<ul class="navbar-nav m-auto mt-lg-0">
						...
						<?php foreach ($tematicas as $key2 => $value) { 
							if (file_exists('../../vistas/juego/juego-gallery.php')){ 
								$gallery = '../../vistas/juego/juego-gallery.php?filtro=tematica&id='.$value;
							}
							if (file_exists('../vistas/juego/juego-gallery.php')){  
								$gallery = '../vistas/juego/juego-gallery.php?filtro=tematica&id='.$value;
							}
							...
							if (file_exists('juego/juego-gallery.php')){
								$gallery = 'juego/juego-gallery.php?filtro=tematica&id='.$value;
							}
							?>
